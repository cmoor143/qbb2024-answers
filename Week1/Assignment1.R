...
#Open file
genome_coverage <- read.delim("/Users/cmdb/qbb2024-answers/Week1/coverages.txt", comment.char = "#")
...
coverages10 <- readr::read_tsv("/Users/cmdb/qbb2024-answers/Week1/coverages10.txt")
...
coverages30 <- readr::read_tsv("/Users/cmdb/qbb2024-answers/Week1/coverages_30x.txt")
